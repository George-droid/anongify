    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="title-header">
                <h2>Select a course to delve into</h2>
                <h6>From the categorized sections</h6>
            </div>
            <!--Filter Breadcrumbs-->
            <div class="categories_block">
              <div class="grid grid-flow-col ">
                <div class="grid-item category_list mt-5">
                  <button class="border-white rounded-pill category_items">All Categories</button>
                  <button class="border-white rounded-pill category_items">Web Development</button>
                  <button class="border-white rounded-pill category_items">Mobile Application Development</button>
                  <button class="border-white rounded-pill category_items">Analytics</button>
                  <button class="border-white rounded-pill category_items">Cloud Computing</button>
                  <button class="border-white rounded-pill category_items">Product</button>
                  <button class="border-white rounded-pill category_items">Poject Management</button>
                </div>
              </div>
            </div>
            ...
            <div class="container showcase mt-5">
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <div class="our_course_category">
                    <!--Frontent Development-->
                    <div class="course_cards_box">
                      <div class="course_card">
                        <div class="hover_color_bubble"></div>
                        <div class="so_top_icon">
                          <img src="data:image/png;base64,">
                        </div>
                        ...
                        <div class="solu_description">
                          <p>
                            Design and build user-friendly, visually appealing web interfaces using HTML, CSS, and JavaScript.</p>
                          <button type="button" class="read_more_btn">Register Course</button>
                        </div>
                      </div>
                    </div>
                    <!--Backend Development-->
                    <div class="course_cards_box">
                      <div class="course_card">
                        <div class="hover_color_bubble"></div>
                        <div class="so_top_icon">
                          <img src="data:image/png;base64,">
                        </div>
                        <div class="solu_title">
                        ...
                        <div class="solu_description">
                          <p>
                            Build robust and scalable web applications by learning php and mastering databases and SQL.</p>
                          <button type="button" class="read_more_btn">Register Course</button>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="course_cards_box">
                      <div class="course_card">
                        ...
                        <div class="solu_description">
                          <p>
                            Develop end-to-end web applications, handling both client-side and server-side components, and become proficient in building complete  web solutions.</p>
                          <button type="button" class="read_more_btn">Register Course</button>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="our_course_category">
                    ...
                    <div class="course_cards_box">
                      <div class="course_card">
                        ...
                        <div class="solu_description">
                          <p>
                            Using flutter to create engaging, responsive, and user-friendly mobile applications tailored to the unique requirements of mobile devices</p>
                          <button type="button" class="read_more_btn">Register Course</button>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="course_cards_box">
                      <div class="course_card">
                        ...
                        <div class="solu_description">
                          <p>
                            Data collection, cleansing, statistical analysis, and data visualization in Python, as well as utilizing insights for data-driven decision-making and business strategies.</p>
                          <button type="button" class="read_more_btn">Register Course</button>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="course_cards_box">
                      <div class="course_card">
                        ...
                        <div class="solu_description">
                          <p>
                            Gain skills in scope definition, resource allocation, risk management, and stakeholder engagement, enabling successful project leadership and timely delivery.</p>
                            <button type="button" class="read_more_btn">Register Course</button>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="our_course_category">
                    ...
                    <div class="course_cards_box">
                      <div class="course_card">
                        ...
                        <div class="solu_description">
                          <p>
                            Learn cloud architecture, virtualization, deployment models, security, and key cloud service providers, enabling you to design, implement, and manage scalable and reliable cloud-based solutions for businesses.</p>
                            <button type="button" class="read_more_btn">Register Course</button>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="course_cards_box">
                      <div class="course_card">
                        ...
                        <div class="solu_description">
                          <p>
                            Principles and methodologies of product design, including user research, prototyping, user interface (UI) design, user experience (UX) design, and usability testing.</p>
                            <button type="button" class="read_more_btn">Register Course</button>
                        </div>
                      </div>
                    </div> 
